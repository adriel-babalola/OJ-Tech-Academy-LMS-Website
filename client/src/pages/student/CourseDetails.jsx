...
const CourseDetails = () => {
  ...
  //   const findCourse = allCourses.find((course) => { return course._id === id })
 ...
 useEffect(() => {
    ...
    const fetchCourseData = () => {
      // It uses 'allCourses' (dependency) and 'id' (stable from useParams)
      const findCourse = allCourses.find((course) => { return course._id === id })
      setCourseData(findCourse)
    }
  ...
  return courseData ? (
    ...
    bg-gradient-to-b from-cyan-100/70"></div>
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="sm">Course by <span className="text-blue-600 underline">OJ Tech</span></p>
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                <div className="border border-gray-300 bg-white mb-2 rounded" key={index}>
                  <div className="flex items justify-between px-4 py-3 cursor-pointer select-none " onClick={() => { toggleSection(index) }}>
                  ...
                  <div className={`overflow-hidden transition-all duration-300 m-h-96 ${openSection[index] ? 'max-h-96' : 'max-h-0'}`}>
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-800 md:text-4xl text-2xl 
              font-semibold">{currency} {(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100).toFixed(2)}</p>
